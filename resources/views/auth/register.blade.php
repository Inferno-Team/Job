        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <!----dob--->
                     <div class="form-group row">
                            <label for="dob" class="col-md-4 col-form-label text-md-right" style="color:black;">{{ __('Date of Birth') }}</label>
                      ...
                      <!---gender--->
                        ...
                        <div class="form-group row">
                            <label for="gender" class="col-md-4 col-form-label text-md-right" style="color:black;">{{ __('Gender') }}</label>
