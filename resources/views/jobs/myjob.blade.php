...
<div class="container">
 ...
 <img src="{{asset('uploads/logo')}}/{{Auth::user()->company->logo}}"style="width:50%;">
        @endif
            ...
            <td><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;<b>Adress:</b>{{$job->address}}</td>
            <td><i class="fa fa-globe" aria-hidden="true"></i>&nbsp;<b>Date:</b>{{$job->created_at->diffForHumans()}}</td>
            <td>
