                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li>
                        <a href="{{route('employer.register')}}" style="color:black;"><b>For Employer</b></a>
                      ...
                      @endif
                       <li><a href="{{route('company')}}" style="color:black;"><b>Company</b></a></li>
                      <li><a href="contact.html"  style="color:black;"><b>Contact</b></a></li>
                      <li>
@if(!Auth::check())
<button type="button" class="btn btn-primary  text-white py-3 px-4 rounded" data-toggle="modal" data-target="#exampleModal" style="background-color:#4997D0;">
  Login
</button>
@else
