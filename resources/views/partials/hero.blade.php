          ...
          <div class="col-12" data-aos="fade">
            ...
            <form action="{{route('alljobs')}}">
              <div class="row mb-3">
                <div class="col-md-9">
                  <div class="row">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <input type="text" name="search"class="mr-3 form-control border-0 px-4" placeholder="job title, keywords or company name ">
                    </div>
                    <div class="col-md-6 mb-3 mb-md-0">
                ...
                <div class="col-md-3">
                  <input type="submit" class="btn btn-search btn-primary btn-block" value="Search" style="background-color:#806545;">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
