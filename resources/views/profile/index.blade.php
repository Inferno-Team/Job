...
<div class="container">
  ...
  <form action="{{route('avatar')}}" method="POST" enctype="multipart/form-data">@csrf
             <div class="card">
            <div class="card-header" style=color:#4997D0><h5><b>Update profile picture</h5></b></div>
            <div class="card-body">
        ...
        <div class="col-md-5">
        <div class="card">
        <div class="card-header" style=color:#4997D0><h5><b>Update Your Profile</h5></b></div>
        ...
        @endif
         ...
         <div class="col-md-4">
           <div class="card">
            <div class="card-header" style=color:#4997D0><h5><b>Your Information</h5></b></div>
            <div class="card-body">
            <p><b><u>Name:</b></u>{{Auth::user()->name}}</p>
              ...
              <p><a href="http://localhost:81/job2/job/storage/app/public/files/RimL9khajzs1H9oPamMD6RvnpflizjoUPUkPVrwq.docx">Resume</a></p>
...
<form action="{{route('cover.letter')}}" method="POST" enctype="multipart/form-data">@csrf
           <div class="card">
            <div class="card-header" style=color:#4997D0><h5><b>Update coverletter<h5><b></div>
            <div class="card-body">
...
<form action="{{route('resume')}}" method="POST" enctype="multipart/form-data">@csrf
             <div class="card">
            <div class="card-header" style=color:#4997D0><h5><b>Update resume<h5><b></div>
            <div class="card-body">
